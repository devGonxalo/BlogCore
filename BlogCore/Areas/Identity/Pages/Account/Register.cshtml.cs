...
namespace BlogCore.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "El {0} deve ser al menos de {2} y máximo {1} de caracteres de longitud.", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "La contraseña y la confirmación no coincinden")]
